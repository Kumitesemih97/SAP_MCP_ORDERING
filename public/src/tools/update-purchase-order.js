import { MOCK_USER, calculateDeliveryDate, findMaterialByKeyword, formatCurrency, } from '../data.js';
import { orderStore } from './order-store.js';
import { poService } from '../services/po-service.js';
export const updatePurchaseOrderTool = {
    name: 'update_purchase_order',
    description: 'Update an existing SAP purchase order (ME22N). Can change quantity, material, vendor, or priority.',
    inputSchema: {
        type: 'object',
        properties: {
            order_number: {
...
export function handleUpdatePurchaseOrder(args) {
    try {
...
//# sourceMappingURL=update-purchase-order.js.map