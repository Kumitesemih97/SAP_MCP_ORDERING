...
export declare class OrderSystemError extends Error {
    code: string;
    details?: unknown | undefined;
    constructor(message: string, code: string, details?: unknown | undefined);
}
export declare class OllamaConnectionError extends Error {
    retryable: boolean;
...
export interface OrderSubmissionResponse extends APIResponse<{
    orderId: string;
}> {
}
