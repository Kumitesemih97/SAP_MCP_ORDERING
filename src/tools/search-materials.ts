...
export const searchMaterialsTool: Tool = {
  ...
  description:
    'Search the material catalog by keyword or category. Returns matching materials with stock levels and prices.',
  inputSchema: {
    type: 'object',
    properties: {
      keyword: {
...
export function handleSearchMaterials(args: Record<string, unknown>) {
